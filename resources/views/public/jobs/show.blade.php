...
@section('head')
{{-- Google Jobs JSON-LD -- Phase 3 inline as planned --}}
<script type="application/ld+json">
    {
        ...
        "validThrough": "{{ $job->deadline?->toIso8601String() ?? now()->addMonths(3)->toIso8601String() }}",
    ...
    <div style="display:grid;grid-template-columns:1fr 340px;gap:28px;align-items:start;">
        ...
        <div>
            ...
            <div style="display:flex;align-items:center;gap:8px;font-size:13px;
                ...
                <span>›</span>
                @if($job->category)
                <a href="{{ route('jobs.index', ['category' => $job->category_id]) }}"
            ...
            <div class="card" style="padding:32px;margin-bottom:20px;">
                ...
                <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:12px;
                    ...
                    <div style="text-align:center;border-left:1px solid var(--bg-muted);">
                        ...
                        <div style="font-size:14px;font-weight:500;color:var(--accent-bright);">
                            {{ $job->salary_display }}
                        </div>
                    </div>
                    <div style="text-align:center;border-left:1px solid var(--bg-muted);">
                ...
                <div style="display:none;">
                    ...
                    <a href="{{ route('jobs.apply', $job) }}" class="btn btn-primary"
            ...
            {{-- Description --}}
            <div class="card" style="padding:32px;margin-bottom:20px;">
                <h3 style="margin-bottom:20px;padding-bottom:12px;
                           border-bottom:1px solid var(--bg-muted);">
                    About this role
                </h3>
                <div style="color:var(--text-secondary);line-height:1.8;font-size:15px;
                            white-space:pre-wrap;">{{ $job->description }}</div>
            </div>
            ...
            <div class="card" style="padding:32px;margin-bottom:20px;">
                ...
                <div style="color:var(--text-secondary);line-height:1.8;font-size:15px;
                            white-space:pre-wrap;">{{ $job->requirements }}</div>
            </div>
            @endif
            ...
            <div class="card" style="padding:32px;margin-bottom:20px;">
                ...
                <div style="color:var(--text-secondary);line-height:1.8;font-size:15px;
                            white-space:pre-wrap;">{{ $job->benefits }}</div>
            </div>
            @endif
        ...
        <div style="position:sticky;top:80px;">
            ...
            <div class="card card-featured" style="padding:28px;margin-bottom:16px;">
                <div style="font-family:var(--font-display);font-size:22px;
                            font-weight:700;color:var(--accent-bright);margin-bottom:4px;">
                    {{ $job->salary_display }}
                </div>
                ...
                <div style="background:rgba(245,158,11,0.1);border:1px solid rgba(245,158,11,0.2);
                                ...
                                font-size:13px;color:var(--warning);margin-bottom:16px;">
            ...
            <div class="card" style="padding:24px;">
                ...
                <p style="font-size:13px;line-height:1.7;margin-bottom:14px;">
                    {{ Str::limit($job->employer->description, 150) }}
                </p>
                @endif
