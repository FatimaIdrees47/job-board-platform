...
<div style="max-width:860px;">
    ...
    <div style="display:grid;grid-template-columns:1fr 300px;gap:20px;align-items:start;">
        ...
        <div style="position:sticky;top:80px;">
            ...
            {{-- Message Candidate --}}
            <div class="card" style="padding:24px;margin-bottom:16px;">
                <h4 style="margin-bottom:14px;font-size:15px;">Message Candidate</h4>
                <form method="POST" action="{{ route('employer.messages.send', $application) }}">
                    @csrf
                    <textarea name="body" class="form-textarea" rows="3"
                        placeholder="Send a message to this candidate..." required></textarea>
                    <button type="submit" class="btn btn-primary btn-sm"
                        style="width:100%;justify-content:center;margin-top:8px;">
                        Send Message
                    </button>
                </form>
                <a href="{{ route('employer.messages.show', $application) }}"
